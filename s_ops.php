...
<div class="sanchead">
				...
				<div id="right">
					...
					<p>
						<ul id="cats">
							<button  onclick="location.href='staff.php'">ADD NEW</button><br><br>
							<button  onclick="location.href='staff_up.php'">UPDATE</button><br><br>
							<button  onclick="location.href='staff_del.php'">DELETE</button><br><br>
						</ul>
					</p>
				</div>
