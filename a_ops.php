...
<div class="sanchead">
				...
				<div id="right">
					...
					<p>
						<ul id="cats">
							<button  onclick="location.href='animal.php'">ADD NEW</button><br><br>
							<button  onclick="location.href='animal_del.php'">DELETE</button><br><br>
							<button  onclick="location.href='a_view.php'">VIEW</button><br><br>
						</ul>
					</p>
				</div>
