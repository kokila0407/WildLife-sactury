...
table{border-collapse:collapse; width:30%; position:absolute; top:250px; left:500px; background-color:black;}
...
if ($result->num_rows > 0) {
    echo "<br><br><tr><th>Animal ID</th><th>Name</th><th>Type</th><th>Food</th><th>Cost</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["a_id"]."</td><td>".$row["a_sp"]."</td><td>".$row["type"]."</td><td>".$row["a_feed"]."</td><td>".$row["a_cost"]."</td></tr>";
    }
